        ...
        .done(function(data) {
            if (data.error){
                ...
                if (data.Cv_Op) {$('#ResultOp').text("Cv: " + data.Cv_Op).show();
                                $('#cavIndexOp').text(" \u03C3 "+ data.CavIndexOp + cavitation_results(data.CavIndexOp)).show()
                                $('#ResultOp').val(data.Cv_Op)
                                $('#liqPropOp').text("Liquid Gf: " + data.rhoOp + " | viscosity: " + data.muOp + " centipoise |"+ "critical pressure: " + data.PcOp + " psi a |" + " vapor pressure: " + data.PsatOp + " psi a")
                ...
                if (data.Cv_Min) {$('#ResultMin').text("Cv: " + data.Cv_Min).show();
                                  ...
                                  $('#cavIndexMin').text(" \u03C3 "+ data.CavIndexMin + cavitation_results(data.CavIndexMin)).show()
                                  $('#liqPropMin').text("Liquid Gf: " + data.rhoMin + " | viscosity: " + data.muMin + " centipoise |"+ "critical pressure: " + data.PcMin + " psi a |" + " vapor pressure: " + data.PsatMin + " psi a").show()
                ...
                if (data.Cv_Max) {$('#ResultMax').text("Cv: " + data.Cv_Max).show();
                                  ...
                                  $('#cavIndexMax').text(" \u03C3 "+ data.CavIndexMax + cavitation_results(data.CavIndexMax)).show()
                                  $('#liqPropMax').text("Liquid Gf: " + data.rhoMax + " | viscosity: " + data.muMax + " centipoise |"+ "critical pressure: " + data.PcMax + " psi a |" + " vapor pressure: " + data.PsatMax + " psi a").show()
